...
export const situacaoDocumento = new Map<string, any>([
    ...
    ['EXPIRADO', {
        ...
        svg: `
            <svg viewBox="0 0 24 24" width="14" height="14">
                <path fill="#d64038" d="M4 2C2.89 2 2 2.89 2 4V20A2 2 0 0 0 4 22H12.41A7 7 0 0 0 16 23A7 7 0 0 0 23 16A7 7 0 0 0 18 9.3V8L12 2H4M11 3.5L16.5 9H11V3.5M16 11A5 5 0 0 1 21 16A5 5 0 0 1 16 21A5 5 0 0 1 11 16A5 5 0 0 1 16 11M15 12V17L18.61 19.16L19.36 17.94L16.5 16.25V12H15Z" />
            </svg>
        `,
        descricao: 'Assinatura expirada. Visualize a lista dos assinantes'
    }],
    ['CANCELADO', {
        css: 'mdi mdi-file-remove tx__gray--d20',
        svg: `
            <svg viewBox="0 0 24 24" width="14" height="14">
                <path fill="#595959" d="M6,2H14L20,8V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V4C4,2.89 4.89,2 6,2M13,9H18.5L13,3.5V9M10,14.59L7.88,12.46L6.46,13.88L8.59,16L6.46,18.12L7.88,19.54L10,17.41L12.12,19.54L13.54,18.12L11.41,16L13.54,13.88L12.12,12.46L10,14.59Z" />
            </svg>
        `,
        descricao: 'Cancelado pelo remetente. Visualize a lista dos assinantes'
    }]
]);
